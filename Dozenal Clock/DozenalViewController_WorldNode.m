...
-(NSMutableArray*) worldPath
{
	...
	// Warp
	//node[0]		= [NSArray arrayWithObjects: @"35", @"0", @"0", @"0", nil];
	
	node[1]		= [NSArray arrayWithObjects: @"2", @"doc1", @"act28", @"0", nil];	// Doc 1
	...
	node[15]	= [NSArray arrayWithObjects: @"16", @"doc6", @"act33", @"13", nil];
