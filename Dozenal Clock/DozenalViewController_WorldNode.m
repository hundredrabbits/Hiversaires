...
-(NSMutableArray*) worldPath
{
	...
	node[5]		= [NSArray arrayWithObjects: @"6", @"0", @"4", @"doc3", nil];
	node[6]		= [NSArray arrayWithObjects: @"0", @"7", @"5", @"0", nil];
	node[7]		= [NSArray arrayWithObjects: @"0", @"8", @"act2", @"6", nil];
	node[8]		= [NSArray arrayWithObjects: @"0", @"0", @"9", @"7", nil];
	node[9]		= [NSArray arrayWithObjects: @"8", @"doc2", @"10", @"0", nil];
	node[10]	= [NSArray arrayWithObjects: @"9", @"0", @"doc3", @"3", nil];
...
- (NSMutableArray*) worldDocument
{
	...
	document[2]		= [NSArray arrayWithObjects: @"First Puzzle", @"Text", @"Graphic", nil];
	document[3]		= [NSArray arrayWithObjects: @"First Puzzle", @"Text", @"Graphic", nil];
