...
const puzzlesByID = (function() {
  ...
  addPuzzle(new SecretEnergyDoor(11, [10]));
  ...
  addPuzzle(
    new SealDoor(
      15,
      [[Zone.metamondst, Zone.rainre], [Zone.antechannel, Zone.rainre]],
      1
    )
  );
  ...
  addPuzzle(new SealDoor(25, [Zone.metamondst, Zone.rainre], 1));
  ...
  addPuzzle(new Entente(43));
  addPuzzle(new Entente(44));
  addPuzzle(new Entente(45));
  addPuzzle(new Entente(46));
